      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg border shadow-sm">
            ...
            <div className="mt-4">
              <span
                className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getPrivacyScoreBg(metrics?.privacyScore || 0)} ${getPrivacyScoreColor(metrics?.privacyScore || 0)}`}
              >
          ...
          <div className="bg-white p-6 rounded-lg border shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">{metrics?.dataGrantsExpired || 0} expired</p>
              </div>
              <svg
                className="h-8 w-8 text-gray-400"
                fill="none"
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        type: 'blue',
                        title: 'Increase Noise Injection',
                        desc: 'Consider adding more statistical noise to improve privacy guarantees',
                      },
                      {
                        type: 'yellow',
                        title: 'Audit Compliance',
                        desc: 'Update audit logs to meet compliance requirements',
                      },
                      {
                        type: 'green',
                        title: 'Data Minimization',
                        desc: 'Reduce data collection to essential fields only',
                      },
                    ].map((rec, index) => (
