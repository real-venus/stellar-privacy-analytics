...
const DocsPage: React.FC = () => {
  ...
  const featuredGuides = [
    {
      title: 'Integrating SMPC with Stellar',
      description: 'Learn how to set up multi-party computation nodes for private transactions.',
    },
    {
      title: 'Zero-Knowledge Proofs 101',
      description: 'A comprehensive guide to implementing ZKPs in your privacy-first application.',
    },
    {
      title: 'Data Encryption Standards',
      description: 'Our recommended encryption protocols for secure data storage and transit.',
    },
  ];
        ...
        <aside className="w-full md:w-64 flex-shrink-0">
          ...
          <div className="px-4">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-sm hover:text-blue-600 flex items-center gap-2">
                  <Download className="w-4 h-4" /> SDK Downloads
                </a>
              </li>
              <li>
                <a href="#" className="text-sm hover:text-blue-600 flex items-center gap-2">
        ...
        <main className="flex-1 min-w-0">
          <div className="mb-10">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl">
              Welcome to the Stellar Privacy Analytics documentation. Explore our guides and API
              reference to build secure, privacy-preserving applications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {featuredGuides.map((guide) => (
              <Card
                key={guide.title}
                className="p-6 hover:shadow-xl transition-shadow cursor-pointer dark:bg-obsidian-900 dark:border-obsidian-800"
              >
                ...
                <div className="flex gap-2">
                  <span className="text-[10px] px-2 py-1 bg-slate-100 dark:bg-obsidian-800 rounded-full font-mono uppercase">
                    Guide
                  </span>
                  <span className="text-[10px] px-2 py-1 bg-slate-100 dark:bg-obsidian-800 rounded-full font-mono uppercase">
                    Intermadiate
...
console.log('Transaction proof generated:', tx.proof);`}
            ...
            <div className="bg-blue-50 dark:bg-blue-900/10 border-l-4 border-blue-600 p-4 rounded-r-lg mb-8">
              <p className="text-sm text-blue-700 dark:text-blue-300 font-medium">
                <strong>Pro Tip:</strong> Always use environmental variables for your API keys.
                Never hardcode them in your frontend application.
              </p>
            </div>
          </article>
        </main>
