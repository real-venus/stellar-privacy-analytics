...
const RiskTrendsChart: React.FC<RiskTrendsChartProps> = ({ data, timeframe, className = '' }) => {
    ...
    <div className={`space-y-6 ${className}`}>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <p className="text-2xl font-bold text-red-600">{latestData?.critical || 0}</p>
                  {getTrendIcon(criticalTrend.direction)}
                </div>
                <p className={`text-xs ${getTrendColor(criticalTrend.direction)}`}>
                  {criticalTrend.change > 0 ? '+' : ''}
                  {criticalTrend.change.toFixed(1)}%
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{latestData?.totalAssessments || 0}</p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Overall privacy risk score over time</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-80">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Number of workflows in each risk category over time</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Number of risk assessments completed over time</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                ...
                />
                <Bar dataKey="totalAssessments" fill="#3b82f6" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
