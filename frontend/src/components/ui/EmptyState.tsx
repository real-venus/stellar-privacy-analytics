...
const NoSearchResultsIllustration: React.FC<{ className?: string }> = ({
  className = 'w-40 h-40',
}) => (
  <svg
    className={className}
...
const NoAuditLogsIllustration: React.FC<{ className?: string }> = ({ className = 'w-40 h-40' }) => (
  ...
  >
    ...
    {/* Shield */}
    <path
      d="M80 36 L112 50 L112 82 C112 100 80 118 80 118 C80 118 48 100 48 82 L48 50 Z"
      fill="#DDD6FE"
      stroke="#A78BFA"
      strokeWidth="3"
    />
...
const NoResultsGenericIllustration: React.FC<{ className?: string }> = ({
  className = 'w-40 h-40',
}) => (
  <svg
    className={className}
