  ...
  messages: [
    {
      ...
      userId: 'u1',
      name: 'Alice',
      text: 'Starting the privacy analysis.',
    ...
    },
    {
      ...
      userId: 'u2',
      name: 'Bob',
      text: "I'll handle the encryption dimension.",
  ...
  history: [
    {
      ...
      userId: 'u1',
      name: 'Alice',
      description: 'Updated privacy level to High',
...
export const CollaborationInterface: React.FC = () => {
  ...
  useEffect(() => {
    const handleOnline = () => {
      ...
      offlineQueueRef.current.forEach((change) =>
  ...
  return (
    <div
      ...
      aria-label="Real-time collaboration workspace"
    >
      {/* Workspace canvas */}
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              aria-live="polite"
              aria-label={
                state.isOnline ? 'Online' : `Offline – ${state.pendingChanges} pending changes`
              }
            >
              {state.isOnline ? (
            ...
            <div
              ...
              aria-label={`${state.presence.length} users active`}
            >
            ...
            {state.messages.map((msg) => (
              ...
              >
                <span className="text-xs text-gray-500 mb-0.5">
                  {msg.userId === CURRENT_USER.userId ? 'You' : msg.name} ·{' '}
