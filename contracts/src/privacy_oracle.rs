...
impl PrivacyOracle {
    ...
    pub fn initialize(env: Env, admin: Address) {
        ...
        env.storage()
            .instance()
            .set(&symbol!("data_source_fees"), &fees);
        env.storage()
            .instance()
            .set(&symbol!("total_requests"), &0u64);
        env.storage()
            .instance()
            .set(&symbol!("total_fees_collected"), &0i128);
    ...
    pub fn request_data(
        ...
        env.storage()
            .instance()
            .set(&symbol!("data_requests"), &requests);
    ...
    pub fn fulfill_request(
        ...
        env.storage()
            .instance()
            .set(&symbol!("data_responses"), &responses);
    ...
    fn set_user_deposit(env: Env, user: Address, deposit: i128) {
        ...
        env.storage()
            .instance()
            .set(&symbol!("user_deposits"), &deposits);
    }
