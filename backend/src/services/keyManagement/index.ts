...
export type { RotationPolicy, RotationSchedule } from "./KeyRotationScheduler";

export { KeyBackupService } from "./KeyBackupService";
export type { BackupConfig, BackupRecord } from "./KeyBackupService";

export { KeySharingService } from "./KeySharingService";
export type { ShareDistribution, ShareRequest } from "./KeySharingService";
...
export type { ZKPKeyPair } from "./ZKPKeyIntegration";
...
export async function getKeyManagementService(): Promise<KeyManagementService> {
  if (!keyManagementServiceInstance) {
    ...
    keyManagementServiceInstance = new KeyManagementService(
      hsmService,
      masterKeyManager,
    );
