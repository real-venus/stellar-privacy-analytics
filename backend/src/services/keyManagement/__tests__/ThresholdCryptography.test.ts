...
describe("ThresholdCryptography", () => {
  ...
  describe("createShares", () => {
    ...
    it("should reject threshold > totalShares", async () => {
      ...
      await expect(
        thresholdCrypto.createShares(secret, 6, 5, [
          "h1",
          "h2",
          "h3",
          "h4",
    ...
    it("should reject threshold < 2", async () => {
      ...
      await expect(
        thresholdCrypto.createShares(secret, 1, 5, [
          "h1",
          "h2",
          "h3",
          "h4",
    ...
    it("should reject empty secret", async () => {
      await expect(
        thresholdCrypto.createShares(Buffer.from([]), 3, 5, [
          "h1",
          "h2",
          "h3",
          "h4",
  ...
  describe("verifyShare", () => {
    it("should verify valid share", async () => {
      const secret = randomBytes(32);
      const shares = await thresholdCrypto.createShares(secret, 3, 5, [
        "h1",
        "h2",
        "h3",
        "h4",
