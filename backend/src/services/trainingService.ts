  ...
  const modules: Partial<TrainingModule>[] = [
    {
      ...
      description:
        "Core concepts of data privacy, GDPR basics, and privacy-by-design principles",
      ...
      exercises: [
        {
          ...
          difficulty: "beginner",
          instructions:
            "Select all items that qualify as personal data under GDPR",
          data: {
            options: [
              {
                id: "a",
                text: "Email address: john.doe@company.com",
                isPersonalData: true,
              },
              {
                id: "b",
                text: "Aggregated sales statistics",
              ...
              {
                id: "e",
                text: "Cookie identifier: abc123xyz",
                isPersonalData: true,
              },
            ],
          },
          hints: [
            ...
            "Even pseudonymous data can be personal data",
          ],
          points: 10,
          feedback: {
            correct:
              "Excellent! You correctly identified all personal data elements.",
            incorrect:
              "Remember: any data that can identify a person (directly or indirectly) is personal data.",
          },
        },
        {
          id: "pf-ex-2",
          ...
          scenario:
            "Your marketing team wants to collect customer email addresses for a newsletter. They plan to use a simple form without any consent explanation.",
          instructions:
            "Identify the privacy issues and recommend the correct approach",
          data: {
            steps: [
              {
                id: 1,
          ...
          hints: [
            "Consider GDPR requirements for consent",
            "Transparency is key",
          ],
          points: 15,
          feedback: {
            correct:
              "Great job! You understand the requirements for lawful data collection.",
            incorrect:
              "Review the GDPR consent requirements and transparency principles.",
          },
        },
      ],
      assessment: {
        ...
        questions: [
          {
            ...
            options: [
              {
                id: "a",
                text: "To protect businesses from data breaches",
                isCorrect: false,
              },
              {
                id: "b",
                text: "To give individuals control over their personal data",
                isCorrect: true,
              },
              {
                id: "c",
                text: "To create a unified market for data sales",
                isCorrect: false,
              },
              {
                id: "d",
                text: "To eliminate cross-border data transfers",
                isCorrect: false,
              },
            ],
            correctAnswer: "b",
            explanation:
              "GDPR aims to give individuals control over their personal data and simplify the regulatory environment for international business.",
            points: 5,
            difficulty: "beginner",
          ...
          },
          {
            ...
            explanation:
              "GDPR principles include lawfulness, fairness, transparency, accuracy, storage limitation, purpose limitation, data minimization, and integrity/confidentiality.",
            points: 10,
            difficulty: "intermediate",
            category: "GDPR Basics",
          },
          {
            ...
            type: "true_false",
            question:
              "Pseudonymized data is no longer considered personal data under GDPR.",
            correctAnswer: false,
            explanation:
              "Pseudonymized data is still personal data under GDPR because it can be attributed to a natural person with additional information.",
            points: 5,
            difficulty: "intermediate",
      ...
      exercises: [
        {
          ...
          difficulty: "advanced",
          instructions:
            "Identify and fix the issues in this differential privacy implementation",
          data: {
            code: `
...
function privateAverage(data, epsilon) {
  ...
  return avg + noise;
          ...
          hints: [
            "Consider the sensitivity of average queries",
            "Think about bounded vs unbounded data",
          ],
          points: 20,
          feedback: {
            correct: "Excellent! You identified all the implementation issues.",
            incorrect:
              "Review the sensitivity calculations for different query types.",
          },
        },
        {
          id: "dp-ex-2",
          ...
          description:
            "Simulate privacy budget consumption across multiple queries",
          difficulty: "advanced",
          scenario:
            "You have a total privacy budget of ε=1.0. Plan the allocation for the following analytics queries while maintaining useful results.",
          instructions:
            "Allocate epsilon values to each query type to balance privacy and utility",
          data: {
            totalBudget: 1.0,
            queries: [
          ...
          hints: [
            "Higher priority queries may need more budget",
            "Consider composition theorems",
          ],
          points: 25,
          feedback: {
            correct:
              "Great budget allocation! You balanced privacy and utility well.",
            incorrect:
              "Consider the privacy-utility trade-off and composition properties.",
          },
        },
      ],
      assessment: {
        ...
        questions: [
          {
            ...
            type: "multiple_choice",
            question:
              "What happens to privacy guarantees when epsilon decreases?",
            options: [
              {
                id: "a",
                text: "Privacy increases, utility decreases",
                isCorrect: true,
              },
              {
                id: "b",
                text: "Privacy decreases, utility increases",
                isCorrect: false,
              },
              {
                id: "c",
                text: "Both privacy and utility increase",
                isCorrect: false,
              },
              {
                id: "d",
                text: "Both privacy and utility decrease",
                isCorrect: false,
              },
            ],
            correctAnswer: "a",
            explanation:
              "Lower epsilon means stronger privacy guarantees but more noise, reducing utility.",
            points: 10,
            difficulty: "intermediate",
          ...
          },
          {
            ...
            type: "fill_blank",
            question:
              "The composition theorem states that running k (ε, δ)-DP mechanisms sequentially results in ___-DP.",
            correctAnswer: "(kε, kδ)",
            explanation:
              "Basic composition: privacy losses add up across multiple queries.",
            points: 15,
            difficulty: "advanced",
    ...
    },
    {
      ...
      description:
        "Best practices for handling sensitive data throughout its lifecycle",
      ...
      exercises: [
        {
          ...
          description:
            "Classify data items by dragging them to the correct category",
          difficulty: "intermediate",
          instructions:
            "Drag each data item to its appropriate classification level",
          data: {
            items: [
              ...
              {
                id: "item3",
                text: "Customer email list",
                correctLevel: "restricted",
              },
              {
                id: "item4",
                text: "Quarterly earnings report (public)",
                correctLevel: "public",
              },
              {
                id: "item5",
                text: "Internal meeting notes",
                correctLevel: "internal",
              },
              {
                id: "item6",
          ...
          hints: [
            "Consider who should have access to each data type",
            "Think about the impact of disclosure",
          ],
          points: 15,
          feedback: {
            correct:
              "Perfect classification! You understand data sensitivity levels.",
        ...
        },
        {
          ...
          difficulty: "intermediate",
          scenario:
            "A customer submits a DSAR requesting all data you hold about them. They also request deletion of specific marketing data.",
          instructions:
            "Follow the correct procedure for handling this request",
          data: {
            steps: [
              {
                id: 1,
              ...
              },
              {
                id: 2,
                question:
                  "How long do you have to respond to the DSAR under GDPR?",
        ...
        questions: [
          {
            ...
            type: "multiple_choice",
            question:
              "What is the minimum retention period for GDPR compliance records?",
            options: [
    ...
    },
    {
      ...
      description:
        "How to detect, respond to, and report privacy incidents and data breaches",
      category: "Security",
      difficulty: "intermediate",
      ...
      exercises: [
        {
          ...
          difficulty: "intermediate",
          scenario:
            "Your security team has detected unauthorized access to a database containing customer PII. Approximately 10,000 records may have been accessed.",
          instructions:
            "Make the correct decisions at each stage of the incident response",
          data: {
            stages: [
              {
                id: "containment",
                ...
                options: [
                  {
                    ...
                    consequence: "Causes unnecessary business disruption",
                  },
                  {
                    id: "b",
                    text: "Revoke compromised credentials and isolate affected systems",
                    consequence: "Correct - limits further damage",
                  },
                  {
                    id: "c",
                    text: "Wait for more information",
                    consequence: "Allows potential ongoing breach",
                  },
                  {
                    id: "d",
                    text: "Notify all customers immediately",
                    consequence: "Premature without full investigation",
                  },
                ],
                correct: "b",
              },
              {
                ...
                question:
                  "Under GDPR, when must you notify the supervisory authority?",
                options: [
          ...
          hints: [
            "Speed is critical but accuracy matters",
            "Consider regulatory requirements",
          ],
          points: 25,
          feedback: {
            correct:
              "Excellent incident response! You minimized damage and met compliance requirements.",
            incorrect:
              "Review GDPR breach notification requirements and incident response best practices.",
          },
        },
      ],
      assessment: {
        ...
        questions: [
          {
            ...
            correctAnswer: "b",
            explanation:
              "GDPR Article 33 requires specific information in breach notifications.",
            points: 15,
            difficulty: "intermediate",
    ...
    },
    {
      ...
      description:
        "Implementing effective consent collection and management systems",
      category: "Compliance",
      difficulty: "intermediate",
      ...
      exercises: [
        {
          ...
          hints: [
            "Required purposes cannot be bundled with consent",
            "Each optional purpose needs separate consent",
          ],
          points: 20,
          feedback: {
            correct:
              "Great consent form design! It meets all GDPR requirements.",
            incorrect:
              "Review the consent requirements: freely given, specific, informed, unambiguous.",
          },
        },
      ],
      assessment: {
        ...
        questions: [
          {
            ...
            type: "true_false",
            question:
              "Pre-ticked checkboxes are acceptable for consent under GDPR.",
            correctAnswer: false,
            explanation:
              "GDPR requires clear affirmative action - pre-ticked boxes do not constitute valid consent.",
            points: 10,
            difficulty: "beginner",
...
export class TrainingService {
  ...
  static createModule(
    moduleData: Partial<TrainingModule>,
    createdBy: string,
  ): TrainingModule {
  ...
  static getUserProgress(
    ...
    const allProgress = Array.from(userProgress.values()).filter(
      (p) => p.userId === userId,
    );
    if (moduleId) {
  ...
  static startModule(
    userId: string,
    moduleId: string,
  ): UserTrainingProgress | { error: string } {
  ...
  static updateProgress(
    ...
    if (module) {
      const contentProgress =
        (progress.currentContentIndex / module.content.length) * 50;
      const exerciseProgress =
        (progress.completedExercises.length / module.exercises.length) * 30;
      const assessmentProgress = progress.status === "completed" ? 20 : 0;
      progress.progress = Math.min(
        100,
        contentProgress + exerciseProgress + assessmentProgress,
      );
    }
  ...
  static submitExercise(
    ...
    const progress = userProgress.get(progressId);
    if (!progress)
      return { error: "Progress not found. Start the module first." };
    ...
    userProgress.set(progressId, progress);
    logger.info(
      `User ${userId} submitted exercise ${exerciseId} in module ${moduleId}`,
    );
    return result;
  }
  ...
  private static evaluateMultipleChoice(
    ...
    const correctOptions = exercise.data.options.filter(
      (o: any) => o.isPersonalData || o.isCorrect,
    );
    ...
    const incorrectCount = selectedOptions.filter(
      (a: string) => !correctOptions.some((co: any) => co.id === a),
    ).length;

    const score = Math.max(
      0,
      ((correctCount - incorrectCount) / correctOptions.length) *
        exercise.points,
    );
    return { score, passed: score >= exercise.points * 0.7 };
  }

  private static evaluateScenario(
    exercise: Exercise,
    answers: any,
  ): { score: number; passed: boolean } {
  ...
  private static evaluateSimulation(
    exercise: Exercise,
    answers: any,
  ): { score: number; passed: boolean } {
  ...
  static startAssessment(
    userId: string,
    moduleId: string,
  ): AssessmentAttempt | { error: string } {
    const module = trainingModules.get(moduleId);
    if (!module) return { error: "Module not found" };
  ...
  static submitAssessment(
    ...
    | { attempt: AssessmentAttempt; passed: boolean; certificate?: Certificate }
    | { error: string } {
    const module = trainingModules.get(moduleId);
    if (!module) return { error: "Module not found" };
    ...
    logger.info(
      `User ${userId} submitted assessment for module ${moduleId}. Score: ${attempt.score}`,
    );
  ...
  static verifyCertificate(verificationCode: string): Certificate | undefined {
    return Array.from(certificates.values()).find(
      (c) => c.verificationCode === verificationCode,
    );
  }

  // Analytics
  static getModuleAnalytics(
    moduleId: string,
  ): TrainingAnalytics | { error: string } {
    const module = trainingModules.get(moduleId);
    if (!module) return { error: "Module not found" };

    const moduleProgress = Array.from(userProgress.values()).filter(
    ...
    return {
      ...
      completionRate:
        moduleProgress.length > 0
          ? (completions.length / moduleProgress.length) * 100
          : 0,
      averageScore:
        completions.length > 0
          ? completions.reduce((sum, p) => sum + p.bestScore, 0) /
            completions.length
          : 0,
      averageTimeSpent:
        moduleProgress.length > 0
          ? moduleProgress.reduce((sum, p) => sum + p.timeSpent, 0) /
            moduleProgress.length
          : 0,
      passRate:
        completions.length > 0
          ? (completions.filter((c) => c.bestScore >= module.passingScore)
              .length /
              completions.length) *
            100
          : 0,
  ...
  private static calculateRoleBreakdown(
    progress: UserTrainingProgress[],
  ): TrainingAnalytics["roleBreakdown"] {
  ...
  private static calculateDropOffPoints(
    module: TrainingModule,
    progress: UserTrainingProgress[],
  ): TrainingAnalytics["dropOffPoints"] {
    const contentDropOff = module.content.map((c) => {
      const reachedCount = progress.filter(
        (p) => p.currentContentIndex >= c.order,
      ).length;
      return {
        contentId: c.id,
        dropOffRate:
          progress.length > 0
            ? ((progress.length - reachedCount) / progress.length) * 100
            : 0,
      };
    });
  ...
  private static calculateExerciseStats(
    module: TrainingModule,
    progress: UserTrainingProgress[],
  ): TrainingAnalytics["exerciseStats"] {
      ...
      return {
        ...
        averageScore:
          results.length > 0
            ...
            : 0,
        attemptRate:
          progress.length > 0 ? (results.length / progress.length) * 100 : 0,
      };
    });
  }
  ...
  private static calculateQuestionStats(
    module: TrainingModule,
    progress: UserTrainingProgress[],
  ): TrainingAnalytics["questionStats"] {
  ...
  static getOverallAnalytics(): {
    ...
    return {
      ...
      activeModules: Array.from(trainingModules.values()).filter(
        (m) => m.isActive,
      ).length,
  ...
  static getOnboardingTraining(role: UserRole): TrainingModule[] {
    return this.getModulesByRole(role)
      .filter(
        (m) => m.difficulty === "beginner" && m.prerequisites.length === 0,
      )
      .slice(0, 3);
  }

  static assignRequiredTraining(
    userId: string,
    role: UserRole,
  ): UserTrainingProgress[] {
    const requiredModules = this.getModulesByRole(role).filter(
    ...
    logger.info(
      `Assigned ${assigned.length} required training modules to user ${userId}`,
    );
    return assigned;
  }
}
