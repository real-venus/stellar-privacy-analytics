...
export class ComplianceWorkflowService {
  ...
  async updateStepStatus(
    ...
    workflow.completionPercentage = this.calculateCompletionPercentage(
      workflow.steps,
    );
  ...
  private async runAutomationScript(
    ...
    logger.info(`Running automation script: ${scriptName}`, {
  ...
  async getWorkflow(
    workflowId: string,
  ): Promise<ComplianceWorkflow | undefined> {
