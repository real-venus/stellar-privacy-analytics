...
export class LegalRequirementsService {
  ...
  private initializeLegalRequirements(): void {
    ...
    const gdprRequirements: LegalRequirement[] = [
      ...
      },
      {
        ...
        description:
          "Controller must notify supervisory authority of breach within 72 hours",
        requirementText:
    ...
    const ccpaRequirements: LegalRequirement[] = [
      {
        ...
        description:
          "Consumer has right to request disclosure of personal information collected",
        requirementText:
        ...
        sourceUrl:
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1798.100",
      ...
      },
      {
        ...
        lastUpdated: new Date("2020-01-01"),
        sourceUrl:
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1798.105",
      ...
      },
      {
        ...
        lastUpdated: new Date("2020-01-01"),
        sourceUrl:
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1798.120",
      ...
      },
      {
        ...
        lastUpdated: new Date("2020-01-01"),
        sourceUrl:
          "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1798.125",
    ...
    const hipaaRequirements: LegalRequirement[] = [
      {
        ...
        requirementText:
          "A covered entity must implement administrative safeguards including security management process, assigned security responsibility, workforce security, information access management, security awareness and training, security incident procedures, contingency plan, evaluation, and business associate contracts",
      ...
      },
      {
        ...
        requirementText:
          "A covered entity must implement physical safeguards including facility access controls, workstation use, workstation security, and device and media controls",
      ...
      },
      {
        ...
        requirementText:
          "A covered entity must implement technical safeguards including access control, audit controls, integrity, person or entity authentication, and transmission security",
    ...
    [...gdprRequirements, ...ccpaRequirements, ...hipaaRequirements].forEach(
      (req) => {
  ...
  private initializeRequirementMappings(): void {
    this.requirementMappings = [
      {
        requirementId: "gdpr_art_5_1_c",
        complianceRuleId: "gdpr-001",
        mappingType: "direct",
      },
      {
        requirementId: "gdpr_art_6",
        complianceRuleId: "gdpr-002",
        mappingType: "direct",
      },
      {
        requirementId: "gdpr_art_17",
        complianceRuleId: "gdpr-003",
        mappingType: "direct",
      },
      {
        requirementId: "gdpr_art_33",
        complianceRuleId: "gdpr-004",
        mappingType: "direct",
      },
      {
        requirementId: "gdpr_art_35",
        complianceRuleId: "gdpr-005",
        mappingType: "direct",
      },
      {
        requirementId: "ccpa_1798_100",
        complianceRuleId: "ccpa-001",
        mappingType: "direct",
      },
      {
        requirementId: "ccpa_1798_105",
        complianceRuleId: "ccpa-002",
        mappingType: "direct",
      },
      {
        requirementId: "ccpa_1798_120",
        complianceRuleId: "ccpa-003",
        mappingType: "direct",
      },
      {
        requirementId: "ccpa_1798_125",
        complianceRuleId: "ccpa-004",
        mappingType: "direct",
      },
      {
        requirementId: "hipaa_164_308",
        complianceRuleId: "hipaa-001",
        mappingType: "direct",
      },
      {
        requirementId: "hipaa_164_310",
        complianceRuleId: "hipaa-002",
        mappingType: "direct",
      },
      {
        requirementId: "hipaa_164_312",
        complianceRuleId: "hipaa-003",
        mappingType: "direct",
      },
      {
        requirementId: "hipaa_164_410",
        complianceRuleId: "hipaa-004",
        mappingType: "direct",
      },
      {
        requirementId: "hipaa_164_502",
        complianceRuleId: "hipaa-005",
        mappingType: "direct",
      },
    ];
  }
  ...
  getRequirementsByRegulation(regulationId: string): LegalRequirement[] {
    return Array.from(this.requirements.values()).filter(
      (req) => req.regulationId === regulationId,
    );
  }
  ...
  getRequirementsByJurisdiction(jurisdiction: string): LegalRequirement[] {
    return Array.from(this.requirements.values()).filter((req) =>
      req.applicableJurisdictions.includes(jurisdiction),
    );
  }
  ...
  getMandatoryRequirements(regulationId?: string): LegalRequirement[] {
    let requirements = Array.from(this.requirements.values()).filter(
      (req) => req.mandatory,
    );
   ...
   */
  getRequirementsForComplianceRule(
    complianceRuleId: string,
  ): LegalRequirement[] {
    const mappings = this.requirementMappings.filter(
      (m) => m.complianceRuleId === complianceRuleId,
    );
    return mappings
  ...
  getRequirementStatistics(): {
    ...
    requirements.forEach((req) => {
      byRegulation[req.regulationId] =
        (byRegulation[req.regulationId] || 0) + 1;
  ...
  isRequirementApplicable(
    ...
    const jurisdictionMatch =
      requirement.applicableJurisdictions.includes(jurisdiction);
