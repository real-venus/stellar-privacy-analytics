...
router.post(
  ...
  [
    ...
    body("maxFailures")
      .isInt({ min: 1 })
      .withMessage("Max failures must be at least 1"),
    body("recoveryTimeout")
      .isInt({ min: 1000 })
      .withMessage("Recovery timeout must be at least 1000ms"),
    body("failoverStrategy").isIn([
      "round_robin",
      "weighted",
      "priority",
      "geographic",
    ]),
    body("backupInstances")
      .isArray()
      .withMessage("Backup instances must be an array"),
...
router.post(
  ...
  [
    ...
    body("backupRegions")
      .isArray()
      .withMessage("Backup regions must be an array"),
    body("dataReplicationDelay")
      .isInt({ min: 0 })
      .withMessage("Data replication delay must be non-negative"),
    body("maxDowntime")
      .isInt({ min: 0 })
      .withMessage("Max downtime must be non-negative"),
    body("recoverySteps")
      .isArray()
      .withMessage("Recovery steps must be an array"),
    body("contactEmails")
      .isArray()
