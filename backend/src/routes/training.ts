...
const moduleIdParam = () =>
  param("moduleId")
    ...
    .withMessage("Invalid moduleId");
const certificateIdParam = () =>
  param("certificateId")
    .trim()
    .matches(/^[a-zA-Z0-9_-]{1,128}$/)
    .withMessage("Invalid certificateId");
const verificationCodeParam = () =>
  param("verificationCode")
    .trim()
    .matches(/^[a-zA-Z0-9_-]{1,128}$/)
    .withMessage("Invalid verificationCode");
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    res.json({
      ...
      message: result.passed
        ...
        : "Exercise submitted. Review the feedback and try again.",
    });
  }),
);
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    res.json({
      ...
      data: {
        ...
        totalPoints: module.assessment.questions.reduce(
          (sum, q) => sum + q.points,
          0,
        ),
...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    const result = TrainingService.submitAssessment(
      userId,
      moduleId,
      attemptId,
      answersMap,
...
router.get(
  ...
  [certificateIdParam(), validateRequest],
  asyncHandler(async (req: Request, res: Response) => {
...
router.get(
  ...
  [verificationCodeParam(), validateRequest],
  asyncHandler(async (req: Request, res: Response) => {
...
router.get(
  "/onboarding/:role",
  [param("role").isIn(TRAINING_ROLES), validateRequest],
  asyncHandler(async (req: Request, res: Response) => {
